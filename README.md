...
WARNING: This code is only to be used for research purposes; not for navigation. The official tidal predictions of the United States are available from NOAA/NOS (www.co-ops.nos.noaa.gov)
